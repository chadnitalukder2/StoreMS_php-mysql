                ...
                <div class="card-body">
                  <form>
                    <div class="form-group">
                      ...
                      <input type="Text"  name="user_first_name" class="form-control" id="exampleInputCategory" aria-describedby="emailHelp"
                        placeholder="Enter User's Firstname">
                    </div>       

                  <div class="form-group">
                      <label for="exampleInputCategory">User's LastName</label>
                      <input type="Text" name="user_last_name" class="form-control" id="exampleInputCategory" aria-describedby="emailHelp"
                        placeholder="Enter User's LastName">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCategory">User's Email</label>
                      <input type="email" name="user_email" class="form-control" id="exampleInputCategory" aria-describedby="emailHelp"
                        placeholder="Enter User's Email">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCategory"> User's Password</label>
                      <input type="password" name="user_password" class="form-control" id="exampleInputCategory" aria-describedby="emailHelp"
