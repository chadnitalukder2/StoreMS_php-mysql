<h5 class="bg-warning text-black p-2 mt-2">Category</h5>
                    ...
                    <h5 class="bg-warning text-black p-2">Report</h5>
                    <ul class="list-group m-2">
                        <li class="list-group-item">
                    ...
                    <h5 class="bg-warning text-black p-2">User</h5>
                    <ul class="list-group m-2">
                        <li class="list-group-item">
                            <a href="add_user.php" class="text-dark text-decoration-none">
                             Add User</a>
                        </li>
                        <li class="list-group-item">
                            <a href="list_of_user.php" class="text-dark text-decoration-none">
                            User List</a>
                        </li>
                    </ul>